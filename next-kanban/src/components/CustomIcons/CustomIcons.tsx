...
const PriorityBacklogOutlined: FC<IColorIconProps> = ({ color }) => {
  return (
    <span
      role="img"
...
const PriorityHighOutlined: FC<IColorIconProps> = ({ color }) => {
  return (
    <span
      role="img"
...
const PriorityNormalOutlined: FC<IColorIconProps> = ({ color }) => {
  return (
    <span
      role="img"
...
const PriorityUrgentOutlined: FC<IColorIconProps> = ({ color }) => {
  return (
    <span
      role="img"
